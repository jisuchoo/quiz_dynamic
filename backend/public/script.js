...
const quizData = [
  { question: "한화 시그니처 여성 건강보험 3.0의 납입면제 강화형 상품에서 암 관련 담보들은 감액기간이 없다.", answer: true },
  { question: "새로 출시한 '암특정치료비(각연간1회한)' 담보는 모든 상품에서 감액기간이 없다.", answer: true },
  ...
  { question: "방광암은 내시경으로 수술하므로 재발이 거의 없는 암이다.", answer: true },
  { question: "프리미엄 올인원 플랜으로 '암특정치료비(각연간1회한)' 3천만원을 포함하여 보험료 20만원을 판매했다면, 1주차의 시상금은 ", answer: true },
];
